...
<head>
  ...
  <title>Pointage Alg1-Acceuil</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Pointage Alg1</li>
      </ol>
      <!-- Icon Cards-->
      <div class="row">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Module 1</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Gestion des Fonctionnaires</span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Module 2</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Gestion de Pointage</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
            </a>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Module 3</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Gestion Des Retards</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
            </a>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white bg-danger o-hidden h-100">
            <div class="card-body">
              ...
              <div class="mr-5">Module 4</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Gestion Des Absences</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
            </a>
